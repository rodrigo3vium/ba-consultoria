  ...
  return (
    <PropostaLayout cliente="Danielle Sena" projeto="Posicionamento Premium">
      ...
      <div className="border-t border-pb-grid-strong py-16 space-y-8">
        ...
        <div className="space-y-4">
          <div className="border border-pb-grid-strong bg-pb-void-card p-6">
            <p className="font-body text-pb-ink-soft leading-relaxed">
              Você tem <strong className="text-pb-ink font-medium">cinco anos de experiência</strong>, um trabalho de excelência e uma visão clara do nível de clínica que quer construir. O que ainda não existe é a imagem que comunica isso ao público que você quer alcançar.
            </p>
          </div>
          <div className="border border-pb-grid-strong bg-pb-void-card p-6">
            <p className="font-body text-pb-ink-soft leading-relaxed">
              A maioria das estratégias de marketing resolve o problema do <strong className="text-pb-ink font-medium">volume</strong>. O que você precisa é de posicionamento — a construção deliberada de uma percepção de valor que atraia quem reconhece qualidade e paga por ela.
            </p>
          </div>
          <div className="border border-pb-grid-strong bg-pb-void-card p-6">
            <p className="font-body text-pb-ink-soft leading-relaxed">
              Não é sobre gravar mais. Não é sobre roteiro. É sobre <strong className="text-pb-ink font-medium">entender o que em você gera desejo nesse público</strong> — e amplificar isso de forma autêntica.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-pb-grid-strong py-16 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            <StratCard key={phase.num}>
              <p className="font-mono text-[10px] uppercase tracking-mono-wide text-pb-ink-muted mb-2">{phase.num}</p>
              <h3 className="font-display uppercase text-pb-ink text-xl leading-tight mb-6">{phase.title}</h3>
        ...
        <StratCard>
          <p className="font-mono text-[10px] uppercase tracking-mono-wide text-pb-cyan mb-6">// Ciclos semanais — meses 2 e 3</p>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              <div key={step.num} className="border border-pb-grid-strong bg-pb-void p-4 text-center">
                <div className="font-mono text-[10px] text-pb-cyan mb-2">{step.num}</div>
                <div className="font-body text-pb-ink-soft text-xs leading-relaxed">{step.label}</div>
              </div>
            ))}
          </div>
        </StratCard>
      ...
      <div className="border-t border-pb-grid-strong py-16 space-y-8">
        ...
        <div className="flex flex-col md:flex-row gap-10 items-start">
          <div className="shrink-0">
            <p className="font-mono text-[10px] uppercase tracking-mono-wide text-pb-ink-muted mb-1">Valor total</p>
            <span className="font-display text-[clamp(48px,6vw,80px)] text-pb-cyan leading-none">R$ 6.000</span>
            <p className="font-mono text-[10px] uppercase tracking-mono-wide text-pb-ink-muted mt-2">3 meses de consultoria</p>
          </div>

          <div className="flex-1 space-y-3">
            <div className="border border-pb-grid-strong bg-pb-void-card p-5">
              <p className="font-mono text-[10px] uppercase tracking-mono-wide text-pb-cyan mb-1">Pix</p>
              <p className="font-body text-pb-ink-soft text-sm">50% na contratação + 50% após 30 dias</p>
            </div>
            <div className="border border-pb-grid-strong bg-pb-void-card p-5">
              <p className="font-mono text-[10px] uppercase tracking-mono-wide text-pb-cyan mb-1">Cartão de crédito</p>
              <p className="font-body text-pb-ink-soft text-sm">3x de R$ 2.000</p>
            </div>
          </div>
        </div>

        <div className="border-t border-pb-grid-strong pt-8">
          <p className="font-mono text-[10px] uppercase tracking-mono-wide text-pb-ink-muted mb-5">O que está incluído</p>
