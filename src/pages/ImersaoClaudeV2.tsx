  ...
  return (
    <div className="ic-page">
      ...
      <section className="ic-hero">
        <div className="ic-container">
          ...
          <h1 className="ic-hero__title">
            ...
            <span className="ic-highlight-arc">o que significa usar IA de verdade no seu negócio.</span>
          </h1>
          ...
          <div style={{ marginTop: 40, borderRadius: 14, border: "0.5px solid rgba(56,189,248,0.14)", overflow: "hidden", fontFamily: "'Exo 2',sans-serif" }}>
            ...
            <div style={{ padding: "18px 18px 14px", background: "#060A12" }}>
              ...
              <svg viewBox="0 0 700 220" xmlns="http://www.w3.org/2000/svg" style={{ display: "block", width: "100%" }}>
                ...
                <rect x="50" y="10" width="15.75" height="180" fill="rgba(245,158,11,0.04)" />
                <rect x="65.75" y="10" width="85.05" height="180" fill="rgba(56,189,248,0.04)" />
                <rect x="150.8" y="10" width="214.2" height="180" fill="rgba(125,211,252,0.03)" />
                <rect x="365" y="10" width="214.2" height="180" fill="rgba(90,112,137,0.03)" />
                <rect x="579.2" y="10" width="100.8" height="180" fill="rgba(61,80,104,0.03)" />
      ...
      <section className="ic-mid-capture">
        <div className="ic-container">
          <h2>"Tá, Rodrigo. <span className="ic-highlight-arc">O que eu faço com isso?</span>"</h2>
          <p style={{ color: "var(--ic-text-secondary)", maxWidth: 580, margin: "12px auto 0", fontSize: "0.95rem" }}>
            É exatamente pra responder essa pergunta que criei a <strong style={{ color: "var(--ic-text-primary)" }}>Imersão em Claude</strong>: 3 aulas onde eu vou te mostrar, na prática, como usar a IA mais poderosa do mercado pra criar sistemas que trabalham pelo seu negócio — e por que existe uma janela de oportunidade aberta agora que não vai durar.
          </p>
      ...
      <section className="ic-section" id="oferta" style={{ background: "radial-gradient(ellipse 80% 60% at 50% 100%, rgba(0,168,232,0.05) 0%, transparent 70%)" }}>
        <div className="ic-container" style={{ textAlign: "center" }}>
          ...
          <p style={{ color: "var(--ic-text-secondary)", maxWidth: 600, margin: "16px auto 0", fontSize: "0.95rem" }}>
            ...
            <strong style={{ color: "var(--ic-text-primary)" }}>ela já se pagou.</strong>{" "}
