...
import { Check, ArrowRight, MessagesSquare, BellRing, Repeat, ShieldCheck } from "lucide-react";
import {
  Form,
  FormControl,
  FormField,
...
import { HeroTriagem, TriagemInboxDemo } from "@/components/portfolio/TriagemInboxDemo";
import { TriagemDashboard } from "@/components/portfolio/TriagemDashboard";
import {
  HERO,
  STATS,
  PROBLEMA,
...
const VIRADA_ICONS = [MessagesSquare, BellRing, Repeat];
...
const formSchema = z.object({
  ...
  imoveis: z.string().min(1, "Selecione uma opção"),
  gargalo: z.string().max(600).optional(),
});
type FormData = z.infer<typeof formSchema>;

const AcabeComADemora = () => {
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [isSubmitted, setIsSubmitted] = useState(false);

  useEffect(() => {
    tracker.page("Portfólio — Acabe com a demora");
  ...
  const form = useForm<FormData>({
    ...
    defaultValues: { nome: "", whatsapp: "", email: "", empresa: "", imoveis: "", gargalo: "" },
  });
    ...
    try {
      const { error } = await supabase.functions.invoke("submit-contact", {
        body: {
          ...
          source: LEAD_SOURCE,
          utm: getPersistedUtm(),
          metadata: { empresa: data.empresa, imoveis: data.imoveis, gargalo: data.gargalo },
        },
      });
  ...
  return (
    <div className="min-h-screen bg-saas-void text-saas-body antialiased">
      <Helmet>
        <title>Acabe com a Demora — Triagem de WhatsApp por IA | BA</title>
        <meta
          name="description"
          content="Uma mensagem de vazamento de gás chega no WhatsApp igual a um pedido de 2ª via de boleto. Veja como a triagem por IA organiza a caixa de entrada de uma imobiliária de aluguel — demo ao vivo, sem cadastro."
        />
      ...
      <header className="relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16 md:pt-16 md:pb-24">
          <div className="rev-item animate-fade-in text-center">
            ...
            <h1 className="font-extrabold text-saas-ink text-[clamp(28px,4.2vw,46px)] leading-[1.14] tracking-tight mb-5">
              {HERO.headline} <Accent>{HERO.headlineAccent}</Accent>
            </h1>
      ...
      <section className="border-t border-white/[0.06] py-20 md:py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rev-item animate-fade-in">
            ...
            <h2 className="font-extrabold text-saas-ink text-[clamp(26px,3.4vw,42px)] leading-[1.12] tracking-tight mb-8 max-w-[24ch]">
      ...
      {/* DOBRA 2 — POR QUE NINGUÉM RESOLVE ISSO */}
      <section className="border-t border-white/[0.06] py-20 md:py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rev-item animate-fade-in">
            <Eyebrow className="mb-5">{VIRADA.eyebrow}</Eyebrow>
            <h2 className="font-extrabold text-saas-ink text-[clamp(26px,3.4vw,42px)] leading-[1.12] tracking-tight mb-6 max-w-[22ch]">
              {VIRADA.headlineFull}
            </h2>
            <p className="text-saas-body text-[17px] leading-relaxed">{VIRADA.intro}</p>
          </div>
          <div className="rev-item animate-fade-in mt-6 grid md:grid-cols-3 gap-4">
            {VIRADA.itens.map((it, i) => {
              const Icon = VIRADA_ICONS[i];
              return (
          ...
          <p className="rev-item animate-fade-in mt-8 text-saas-body text-[17px] leading-relaxed">{VIRADA.fecho}</p>
        </div>
      </section>
      ...
      {/* DOBRA 5 — O PAINEL DO GESTOR */}
      <section id="painel" className="border-t border-white/[0.06] py-20 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rev-item animate-fade-in text-center mb-10">
            <Eyebrow className="mb-5">{PAINEL.eyebrow}</Eyebrow>
            <h2 className="font-extrabold text-saas-ink text-[clamp(26px,3.4vw,42px)] leading-[1.12] tracking-tight mb-4 max-w-[24ch] mx-auto">
              {PAINEL.headlineFull}
            </h2>
            <p className="text-saas-muted text-base md:text-lg leading-relaxed max-w-[56ch] mx-auto">{PAINEL.sub}</p>
          </div>
          <div className="rev-item animate-fade-in">
            <TriagemDashboard />
          </div>
      ...
      {/* DOBRA 6 — POR QUE ISSO NÃO É CHATGPT */}
      <section className="border-t border-white/[0.06] py-20 md:py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rev-item animate-fade-in">
      ...
      {/* DOBRA 7 — O QUE O SISTEMA SE RECUSA A FAZER */}
      <section className="border-t border-white/[0.06] py-20 md:py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rev-item animate-fade-in">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <div className="rev-item animate-fade-in">
              ...
              <h2 className="font-extrabold text-saas-ink text-[clamp(28px,3.6vw,44px)] leading-tight mb-5 max-w-[22ch]">
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <input type="email" placeholder="voce@imobiliaria.com" className={SAAS_INPUT} {...field} />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <label className={SAAS_LABEL}>Imobiliária / administradora</label>
                              <FormControl>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <label className={SAAS_LABEL}>Imóveis sob gestão</label>
                              <FormControl>
                                <select className={SAAS_INPUT} {...field}>
                                  <option value="" disabled>
                                    Selecione
                                  </option>
                                  {IMOVEIS_OPTIONS.map((o) => (
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <label className={SAAS_LABEL}>Onde o WhatsApp mais machuca sua operação hoje? (opcional)</label>
                            <FormControl>
                              <textarea
                                rows={3}
                                placeholder="Em uma frase, onde a fila mais atrasa ou mais assusta."
      ...
      <footer className="border-t border-white/[0.06] py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="rev-item animate-fade-in font-extrabold text-saas-ink text-[clamp(24px,3.4vw,40px)] leading-tight max-w-[28ch] mb-10">
            {FOOTER.manifestoBefore} <Accent>{FOOTER.manifestoAccent}</Accent>
          </p>
...
export default AcabeComADemora;
