        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-5xl mx-auto">
            ...
            <h1 className="text-3xl md:text-5xl font-bold font-poppins mb-6 leading-tight text-white">
              Treinei o ChatGPT para me deixar <span className="text-green-400">mais produtivo</span> (e inteligente). Agora você vai fazer o mesmo.
            </h1>
            
            <h2 className="text-lg md:text-2xl text-gray-300 mb-6 font-inter leading-snug md:leading-relaxed max-w-5xl mx-auto">
              Com o <span className="text-blue-400 font-semibold">IA do Zero</span>, você aprende a usar o ChatGPT <span className="text-green-400 font-semibold">(E outras IAs)</span> de forma prática para aprender mais rápido e atingir seus objetivos por apenas <span className="text-green-400 font-bold">R$49,90</span>.
            </h2>
