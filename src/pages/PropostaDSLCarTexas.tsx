    ...
    <>
      ...
      <div className="dsl-page">
        ...
        >
          ...
          <img loading="lazy" src={dslLogo} alt="DSL Car Texas" style={{ width: "120px", height: "120px", objectFit: "cover", borderRadius: "50%", marginBottom: "32px", animation: "dsl-fadeDown 0.8s ease both" }} />
        ...
        <section style={{ padding: "100px 24px", maxWidth: "1100px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: "20px" }} className="dsl-mentors-grid">
            {[
      ...
      <style>{`
        @media (max-width: 768px) {
          ...
          .dsl-mentors-grid { grid-template-columns: repeat(2, 1fr) !important; }
        }
      `}</style>
    </>
  );
