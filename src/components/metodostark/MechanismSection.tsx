...
const beliefs = [
  ...
  },
  {
    ...
    text: "Sistemas, prompts e resultados reais compartilhados entre pessoas que operam negócios — isso vale mais do que qualquer aula gravada. O Estado Alpha é uma comunidade de praticantes, não um grupo de estudantes.",
  },
];
...
const alphaItems = [
  ...
  },
  {
    ...
    text: "Um assistente especializado disponível 24 horas, treinado no método do Estado Alpha. Você não precisa esperar pela próxima aula para tirar uma dúvida ou validar uma arquitetura.",
  },
  {
    num: "004",
  ...
  },
  {
    ...
    text: "O campo de IA muda toda semana. O Estado Alpha evolui com ele. Novas ferramentas, novos módulos, novos sistemas — inclusos sem custo adicional.",
  },
];
      ...
      <section className="px-6" style={{ paddingTop: "100px", paddingBottom: "100px", backgroundColor: SURFACE }}>
        <div className="max-w-5xl mx-auto space-y-16">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-6">
            ...
            >
              Por trás do Estado Alpha existe um conjunto de convicções sobre como o trabalho vai funcionar daqui para frente — e sobre o que separa os profissionais que vão liderar essa transição dos que vão ser engolidos por ela.
            </p>
          </div>
        ...
        <div className="max-w-5xl mx-auto space-y-16">
          ...
          <div className="text-center max-w-3xl mx-auto">
            <p
              ...
              style={{ fontFamily: FONT_BODY, color: TEXT_COLOR, lineHeight: 1.8, fontWeight: 300 }}
            >
              O Estado Alpha não é um curso avulso sobre IA. É um sistema integrado de educação, prática e comunidade — construído para que você saia com sistemas funcionando no seu negócio, não com slides para revisar nas férias.
            </p>
          </div>
